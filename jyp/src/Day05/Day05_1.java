...
public class Day05_1 {
	public static void main(String[] args) {
		...
		// 제어문 : if [ 논리(t/f)제어 검사 ] , switch [ 데이터 검사 ]
			// if : 경우의 수가 정해져 있지 않는 경우
				// true 이면 실행문 처리 후 모든 if 종료
			// switch : 경우의 수가 정해져 있는 경우 [ 속도 빠름 ]
...
//////////////////////////////////////////////////////////////////		
		...
		int 점수1 = 80 ; int 점수2 = 90 ; int 점수3 = 100 ;
			// 세 점수의 평균을 계산 후 90점 이상이면 A등급 80점 이상이면 B등급 70점 이상이면 C등급 그외 탈락
			switch ((점수1+점수2+점수3)/30) {
			case 10 : 
